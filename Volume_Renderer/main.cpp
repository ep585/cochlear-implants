...
// instance modifiers
void UpdateSourceOffset(const vec2 &newSourceOffset){ xRay.UpdateSourceOffset(newSourceOffset); }
...
int main(int argc, const char *argv[]) {
	...
	float (*const &similarityMetric)(const Array2D<uint16_t> &, const Array2D<uint16_t> &, bool (*const &)(const int &, const int &)) = &SimMetric::HackyGradient;
