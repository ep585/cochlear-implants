...
float SumAbsoluteDifferences(const Array2D<uint16_t> &arrayX, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
...
float MutualInformation(const Array2D<uint16_t> &arrayX, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
	assert(arrayX.Width() == arrayY.Width());
	assert(arrayX.Height() == arrayY.Height());
	const unsigned int w = arrayX.Width();
	const unsigned int h = arrayX.Height();
...
float CorrelationRatio(const Array2D<uint16_t> &arrayX, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
	assert(arrayX.Width() == arrayY.Width());
	assert(arrayX.Height() == arrayY.Height());
	const unsigned int w = arrayX.Width();
	const unsigned int h = arrayX.Height();
...
float CorrelationCoefficient(const Array2D<uint16_t> &arrayX, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
	assert(arrayX.Width() == arrayY.Width());
	assert(arrayX.Height() == arrayY.Height());
	const unsigned int w = arrayX.Width();
	const unsigned int h = arrayX.Height();
...
float HackyGradient(const Array2D<uint16_t> &arrayX, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
	assert(arrayX.Width() == arrayY.Width());
	assert(arrayX.Height() == arrayY.Height());
	const unsigned int w = arrayX.Width();
	const unsigned int h = arrayX.Height();
	...
	for(int jm=0; jm<hm; jm++) for(int im=0; im<wm; im++){
		...
		for(int l1=0; l1<grad_k; l1++) for(int l2=0; l2<grad_k; l2++){
			gX += v[l1]*(vec2){(float)arrayX(j + l2, i + l1), (float)arrayX(j + l1, i + l2)};
			gY += v[l1]*(vec2){(float)arrayY(j + l2, i + l1), (float)arrayY(j + l1, i + l2)};
		}
...
float GradientCorrelation(const Array2D<uint16_t> &arrayX, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
	assert(arrayX.Width() == arrayY.Width());
	assert(arrayX.Height() == arrayY.Height());
	const unsigned int w = arrayX.Width();
	const unsigned int h = arrayX.Height();
...
void SaveRects(const char *filenameX, const Array2D<uint16_t> &arrayX, const char *filenameY, const Array2D<uint16_t> &arrayY, bool (*const &exclude)(const int &, const int &)){
	assert(arrayX.Width() == arrayY.Width());
	assert(arrayX.Height() == arrayY.Height());
	const unsigned int w = arrayX.Width();
	const unsigned int h = arrayX.Height();
