...
function FindApproxTransformation(dataName, plot)
    ...
    name = dataDirectory + dataName + "/plys/left scala tympani.ply";
    ...
    name = dataDirectory + dataName + "/plys/right scala tympani.ply";
    ...
    name = dataDirectory + dataName + "/plys/left otic capsule.ply";
    if isfile(name)
        copyfile(name, outputDirectory);
    end
    name = dataDirectory + dataName + "/plys/right otic capsule.ply";
    if isfile(name)
        copyfile(name, outputDirectory);
    end
