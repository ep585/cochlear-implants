...
for simMetricName in simMetricNames:
	...
	axs[1, 0].plot(vX, scan[2], label="ct z ~ " + f"{centre[2]:.3}") # wobbles more, so putting first (behind)
	axs[1, 0].plot(vX, scan[0], label="ct x ~ " + f"{centre[0]:.3}")
	axs[1, 0].plot(vX, scan[1], label="ct y ~ " + f"{centre[1]:.3}")
	...
	axs[1, 1].plot(vX, scan[6], label="src. x ~ " + f"{centre[6]:.3}")
	axs[1, 1].plot(vX, scan[7], label="src. y ~ " + f"{centre[7]:.3}")
	...
	axs[0, 0].plot(vX, scan[5], label="ct yaw ~ " + f"{centre[5]:.3}") # wobbles more, so putting first (behind)
	axs[0, 0].plot(vX, scan[3], label="ct roll ~ " + f"{centre[3]:.3}")
	axs[0, 0].plot(vX, scan[4], label="ct pitch ~ " + f"{centre[4]:.3}")
